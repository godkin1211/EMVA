simulator<-function(inputData, 
                    ...
                    runs=5, 
                    ksets=list(k1=10,k2=10,k3=10,k4=10,k5=10,k6=50),
        ...
        for (j in seq(runs)){
            ...
            for (m in selected.md) {
                if (m == "zero") {
                    ...
                    imputedData <- impute(testData, method="knn", k=ksets$k1)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
                    ...
                    imputedData <- impute(testData, method="sknn", k=ksets$k2)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
                    ...
                    imputedData <- impute(testData, method="iknn", k=ksets$k3)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
                    ...
                    imputedData <- impute(testData, method="svd", k=ksets$k4)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
                    ...
                    imputedData <- impute(testData, method="ls", k=ksets$k5)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
                    ...
                    imputedData <- impute(testData, method="lls", k=ksets$k6)
                    for (p in performance.idx) {                     
                        performance <-evaluator(imputedData,method=p)
